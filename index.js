...
let fruits = [];
{if (req.body.buildersname.length < 1){req.body.buildersname1 = ''}else{req.body.buildersname1 = '<span><b>Builders Name</b></span><br />'}};
{if (req.body.buildersname.length < 1){req.body.buildersname2 = ''}else{req.body.buildersname2 = `<span>`+req.body.buildersname+`</span><br />`}};
{if (req.body.dontwantstatement.length < 1){req.body.dontwantstatement1 = ''}else{req.body.dontwantstatement1 = '<span><b>Anything You Dont Want In Your Dream Kitchen.</b></span><br />'}};
{if (req.body.dontwantstatement.length < 1){req.body.dontwantstatement2 = ''}else{req.body.dontwantstatement2 = `<span>`+req.body.dontwantstatement+`</span><br />`}};
...
<tbody>
<tr style="bgcolor:#000000; color:#000000"><td width="100%" valign="top" align="center" class="links-color" style="bgcolor:#000000; color:#000000"><!--[if (lte ie 8)]><div style="display: inline-block; width: 166px; -mru-width: 0px" style="bgcolor:#000000; color:#000000"><![endif]--><img border="0" hspace="0" align="center" vspace="0" width="166" style="border: 0px; display: block; vertical-align: top; height: auto; margin: 0 auto; color: #f3f3f3; font-size: 18px; font-family: Arial, Helvetica, sans-serif; width: 100%; max-width: 166px; height: auto;" src="https://mosaico.io/srv/f-4228j1i/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2F4228j1i%2Ficon-192.png&amp;method=resize&amp;params=166%2Cnull"><!--[if (lte ie 8)]></div><![endif]--></td></tr>
<tr>
...
<tr><td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #3f3f3f; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal">Dear `+req.body.fullname+`,<br />
We wanted to let you know we got your quote. Below is a list of all the options you asked for.
<br />`+req.body.buildersname1+``+req.body.buildersname2+`<span><b>Parking</b></span><br /><span>`+req.body.parking+`</span><br /><span><b>Project Type</b></span><br /><span>`+req.body.projecttype+`</span><br /><span><b>Kitchen Style</b></span><br /><span>`+req.body.kitchenstyle+`</span><br /><span><b>Worktop Style</b></span><br /><span>`+req.body.worktopstyle+`</span><br /><span><b>Fitters Required</b></span><br /><span>`+req.body.fittersrequired+`</span><br /><span><b>Price Range</b></span><br /><span>`+req.body.pricerange+`</span><br />
<b>Appliances Required</b><table style="border: 1px solid black; text-align: center; background-color: white; width: 100%"><tr><td>Fridges</td><td>Freezers</td><td>Ovens</td><td>Hobs</td><td>Microwaves</td></tr><tr>
...
<br /><span><b>Kitchen Colour</b></span><br />
<span>`+req.body.kitchencolour+`</span><br />
<span><b>Time Scale</b></span><br />
<span>`+req.body.timescale+`</span><br />`+req.body.dontwantstatement1+``+req.body.dontwantstatement2+`
<br />
Thank you for completing this form. One of the team will be in touch shortly to discuss your upcoming project!<br />
&nbsp;To aid in transparency we have sent some information about who we are, our terms and conditions alongside some pre-fitting requirements.”<br />
</td>
</tr>
<tr>
